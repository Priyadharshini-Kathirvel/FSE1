...
public class ExceptionHandlerControllerAdvice {
	...
	public @ResponseBody ExceptionResponse handleInvalidTokenException(InvalidTokenException exception,
			HttpServletRequest request) {
		log.info("START - handleInvalidTokenException() of ExceptionHandlerControllerAdvice");
		log.info("END - handleInvalidTokenException() of ExceptionHandlerControllerAdvice");
		return setExceptionResponseDetails(exception.getMessage(), request.getRequestURI());
	}

	@ExceptionHandler(InvalidInputException.class)
	@ResponseStatus(value = HttpStatus.NOT_FOUND)
	public @ResponseBody ExceptionResponse handleInvalidUserCredentialsException(
			InvalidInputException exception, HttpServletRequest request) {
		log.info("START - handleInvalidUserCredentialsException() of ExceptionHandlerControllerAdvice");
		log.info("END - handleInvalidUserCredentialsException() of ExceptionHandlerControllerAdvice");
		return setExceptionResponseDetails(exception.getMessage(), request.getRequestURI());
	}

	@ExceptionHandler(TweetNotFoundException.class)
	@ResponseStatus(value = HttpStatus.NOT_FOUND)
	public @ResponseBody ExceptionResponse handleTweetNotFoundException(TweetNotFoundException exception,
			HttpServletRequest request) {
	...
	@ResponseStatus(value = HttpStatus.NOT_FOUND)
	public @ResponseBody ExceptionResponse handleUserAlreadyExistException(UserAlreadyExistException exception,
			HttpServletRequest request) {
		log.info("START - handleTweetNotFoundException() of ExceptionHandlerControllerAdvice");
		log.info("END - handleTweetNotFoundException() of ExceptionHandlerControllerAdvice");
		return setExceptionResponseDetails(exception.getMessage(), request.getRequestURI());
	...
	@ResponseStatus(value = HttpStatus.NOT_FOUND)
	public @ResponseBody ExceptionResponse handleUserNotFoundException(UserNotFoundException exception,
			HttpServletRequest request) {
